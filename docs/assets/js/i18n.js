$.i18n().load({
  ...
  "en": {
    ...
    "ta-time-series-text": "This shows the numbers of detained persons over the last four years of data. Our effort here is in line with [other efforts](https://www.freedomforimmigrants.org/detention-statistics/) at quantification.",
    ...
    "ta-bookins-text": "The initial [book-ins](http://www.politifact.com/truth-o-meter/article/2017/dec/19/have-deportations-increased-under-donald-trump-her/) into detention facilities rate",
    "ta-fy2017-num": "fy2017 number.",
    "ta-fy2017-text": "fy2017 text",
    "ta-operators-num": "Operators number.",
   "ta-operators-text": "The facility can be operated by ICE, GEO, MVM, CCA [or other contractors](https://www.reuters.com/article/us-usa-immigration-prison-stocks/prison-operator-shares-rise-on-trump-immigration-executive-order-idUSKBN1JG3FW)",
    "ta-active-num": "active number.",
    "ta-active-text": "ADP is the Active Daily Population and represents someone in ICE detention. However, this is as fungible a number as any other and depends on Congressional language for 'beds'.",
...
"es": {
    ...
    "ta-time-series-text": "Número de personas detenidas basado en datos de los ultimo 4 años. Nuestro esfuerzo es similar a [otros similares](https://www.freedomforimmigrants.org/detention-statistics/).",
    ...
    "ta-bookins-text": "Medida inicial de [arrestos](http://www.politifact.com/truth-o-meter/article/2017/dec/19/have-deportations-increased-under-donald-trump-her/)",
    ...
    "ta-active-text": "ADP es la Actividad Población Diaria y representa a alguien en detención de ICE. Sinembargo, este número es relativo y depende de la definición del congreso de una 'cama'.",
   "ta-operators-text": "La instalación puede ser operada por ICE, GEO, MVM, CCA [o otros contratistas](https://www.reuters.com/article/us-usa-immigration-prison-stocks/prison-operator-shares-rise-on-trump-immigration-executive-order-idUSKBN1JG3FW)",
