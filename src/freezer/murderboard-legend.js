...
export default function(){
  ...
  $("#legend").show().html(() => {
    ...
    html.push(`<div class = "row form-group"><div class = "col-md-1"><svg class="legend-svg" height="${ size}" width="${size}">
          <rect height="${size}" width="${size}" class="legend-polygon" fill="${orange}" /></svg></div>`)
