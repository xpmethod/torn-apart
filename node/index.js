...
class NewsAPI {
  constructor (apiKey) {
    ...
    this.v2 = {
      ...
      everything (DetentionLocation, ...args) {
        ...
        return getDataFromWeb(DetentionLocation, url, options, API_KEY, cb);
      },
 ...
 */
function getDataFromWeb(DetentionLocation, url, options, apiKey, cb) {
  //console.log("DetentionLocation = " + DetentionLocation);
